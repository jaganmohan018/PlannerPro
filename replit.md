...
- June 27, 2025. Updated date picker implementation to restrict selection to only the past 7 days. Changed button text to "View Past 7 Days" and interface now shows "Select Date from Past 7 Days" with a date input that has a minimum date of 7 days ago and maximum of today. This provides a focused, user-friendly way to view recent historical data.
